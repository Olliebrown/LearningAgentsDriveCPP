...
#include "DriveAgentsCPPSportsCar.h"
#include "DriveAgentsCPPSportsWheelFront.h"
#include "DriveAgentsCPPSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ADriveAgentsCPPSportsCar::ADriveAgentsCPPSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UDriveAgentsCPPSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UDriveAgentsCPPSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UDriveAgentsCPPSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UDriveAgentsCPPSportsWheelRear::StaticClass();
